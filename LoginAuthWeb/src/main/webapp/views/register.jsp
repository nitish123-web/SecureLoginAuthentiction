            ...
            <div class="card shadow-lg">
                <div class="card-body">
                    <form action="success" method="POST">
                        ...
                        <div class="mb-2 mt-1">
                            <label for="empid" class="form-label">Employee Name</label>
                            <input type="text" class="form-control" id="EmpName" name="Empname" placeholder="Enter name" required>
                        </div>
                                                <div class="mb-2 mt-1">
                            <label for="empid" class="form-label">Employee Mail</label>
                            <input type="email" class="form-control" id="EmpMail" name="Empmail" placeholder="Enter mail" required>
                        </div>
                        <div class="mb-2">
